export default function renderWebsite(website, parentContainer) {
  const markup = `<div data-id ="${website.id}" class="website">
  <p class="website-name">
    <a href="${website.address}" target="_blank" rel="noopener noreferrer">${website.name}</a>
  </p>
